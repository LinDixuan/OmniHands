...
class Renderer:
    ...
    def render_rgba_multiple(
            ...
            rot_axis=[1, 0, 0],
            rot_angle=0,
            mesh_base_color=[(1.0, 1.0, 0.9), (1.0, 1.0, 0.9)],
            scene_bg_color=(0, 0, 0),
            render_res=[256, 256],
            focal_length=None,
            is_right=None,
        ...
        mesh_list = [pyrender.Mesh.from_trimesh(
            self.vertices_to_trimesh(vvv, ttt.copy(), mesh_base_color[int(sss) % len(mesh_base_color)], rot_axis,
                                     rot_angle, is_right=sss)) for vvv, ttt, sss in zip(vertices, cam_t, is_right)]
